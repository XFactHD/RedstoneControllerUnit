...
public enum Opcode
{
    ...
    //Regular 0x44-0x4F
    ORL_IMM         ("ORL",     2, 1, ParseHelpers.makeTwoArgOneConstOneImmediateParser("A", false)),
    ...
    //Regular 0x54-0x5F
    ANL_IMM         ("ANL",     2, 1, ParseHelpers.makeTwoArgOneConstOneImmediateParser("A", false)),
    ...
    //Regular 0x64-0x6F
    XRL_IMM         ("XRL",     2, 1, ParseHelpers.makeTwoArgOneConstOneImmediateParser("A", false)),
    ...
    MOV_DR1_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R1")),
    MOV_DR2_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R2")),
    MOV_DR3_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R3")),
    MOV_DR4_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R4")),
    MOV_DR5_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R5")),
    MOV_DR6_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R6")),
    MOV_DR7_IMM     ("MOV",     2, 1, ParseHelpers.makeTwoConstArgParser("A", "R7")),
    //Irregular 0x80-0x83
    ...
    MOV_MEM_DR0     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R0", true)),
    MOV_MEM_DR1     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R1", true)),
    MOV_MEM_DR2     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R2", true)),
    MOV_MEM_DR3     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R3", true)),
    MOV_MEM_DR4     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R4", true)),
    MOV_MEM_DR5     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R5", true)),
    MOV_MEM_DR6     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R6", true)),
    MOV_MEM_DR7     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R7", true)),
    //Irregular 0x90-0x93
    ...
    MOV_DR0_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R0", false)),
    MOV_DR1_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R1", false)),
    MOV_DR2_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R2", false)),
    MOV_DR3_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R3", false)),
    MOV_DR4_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R4", false)),
    MOV_DR5_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R5", false)),
    MOV_DR6_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R6", false)),
    MOV_DR7_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("R7", false)),
    //Irregular 0xB0-0xB3
    ...
    MOV_ACC_MEM     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("A", false)),
    MOV_ACC_IR0     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "@R0")),
    MOV_ACC_IR1     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "@R1")),
    MOV_ACC_DR0     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R0")),
    MOV_ACC_DR1     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R1")),
    MOV_ACC_DR2     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R2")),
    MOV_ACC_DR3     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R3")),
    MOV_ACC_DR4     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R4")),
    MOV_ACC_DR5     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R5")),
    MOV_ACC_DR6     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R6")),
    MOV_ACC_DR7     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("A", "R7")),
    //Irregular 0xF0-0xF3
    ...
    MOV_MEM_ACC     ("MOV",     2, 1, ParseHelpers.makeTwoArgOneConstOneAddressParser("A", true)),
    MOV_IR0_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("@R0", "A")),
    MOV_IR1_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("@R1", "A")),
    MOV_DR0_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R0", "A")),
    MOV_DR1_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R1", "A")),
    MOV_DR2_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R2", "A")),
    MOV_DR3_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R3", "A")),
    MOV_DR4_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R4", "A")),
    MOV_DR5_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R5", "A")),
    MOV_DR6_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R6", "A")),
    MOV_DR7_ACC     ("MOV",     2, 0, ParseHelpers.makeTwoConstArgParser("R7", "A")),
    ;
