        ...
        for (MutableInt counter = new MutableInt(); counter.intValue() < rom.length; ) {
            ...
            switch (opcode) {
                ...
                case INC_DR0, INC_DR1, INC_DR2, INC_DR3, INC_DR4, INC_DR5, INC_DR6, INC_DR7,
                     DEC_DR0, DEC_DR1, DEC_DR2, DEC_DR3, DEC_DR4, DEC_DR5, DEC_DR6, DEC_DR7 -> line.append(printRegisterDirect(opcode));
                case INC_DPTR -> line.append("DPTR");
                case ADD_IMM, ADDC_IMM, ORL_IMM, ANL_IMM, XRL_IMM, SUBB_IMM, MOV_ACC_IMM -> line.append("A,").append(printImmediate(rom[counter.getAndIncrement()]));
                case ADD_MEM, ADDC_MEM, ORL_MEM, ANL_MEM, XRL_MEM, SUBB_MEM, MOV_ACC_MEM -> line.append("A,").append(printAddress(rom[counter.getAndIncrement()]));
                case ADD_IR0, ADD_IR1, ADDC_IR0, ADDC_IR1, ORL_IR0, ORL_IR1, ANL_IR0, ANL_IR1, XRL_IR0, XRL_IR1, SUBB_IR0, SUBB_IR1, MOV_ACC_IR0, MOV_ACC_IR1 -> line.append("A,").append(printRegisterIndirect(opcode));
                case ADD_DR0, ADD_DR1, ADD_DR2, ADD_DR3, ADD_DR4, ADD_DR5, ADD_DR6, ADD_DR7,
                     ...
                     MOV_ACC_DR0, MOV_ACC_DR1, MOV_ACC_DR2, MOV_ACC_DR3, MOV_ACC_DR4, MOV_ACC_DR5, MOV_ACC_DR6, MOV_ACC_DR7 -> line.append("A,").append(printRegisterDirect(opcode));
                ...
                case XCH_DR0, XCH_DR1, XCH_DR2, XCH_DR3, XCH_DR4, XCH_DR5, XCH_DR6, XCH_DR7 -> line.append("A,").append(printRegisterDirect(opcode));
