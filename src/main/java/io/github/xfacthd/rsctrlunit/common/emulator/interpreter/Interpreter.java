...
public final class Interpreter {
    ...
    private void runInternal() {
        ...
        switch (opcode) {
            ...
            case RR ->
                    OpcodeHelpers.readModifyWriteAccumulator(ram, (_, value) -> {
            ...
            case INC_ACC ->
                    OpcodeHelpers.readModifyWriteAccumulator(ram, (_, value) -> value + 1);
            case INC_MEM ->
                    OpcodeHelpers.readModifyWriteMemory(ram, readRomAndIncrementPC(), (_, value) -> value + 1);
            case INC_IR0, INC_IR1 ->
                    OpcodeHelpers.readModifyWriteRegisterIndirect(ram, romByte & 0x1, (_, value) -> value + 1);
            case INC_DR0, INC_DR1, INC_DR2, INC_DR3, INC_DR4, INC_DR5, INC_DR6, INC_DR7 ->
                    OpcodeHelpers.readModifyWriteRegister(ram, romByte & 0b00000111, (_, value) -> value + 1);
            case INC_DPTR -> {
            ...
            case XRL_DR0, XRL_DR1, XRL_DR2, XRL_DR3, XRL_DR4, XRL_DR5, XRL_DR6, XRL_DR7 -> OpcodeHelpers.xorAcc(ram, OpcodeHelpers.readRegisterDirect(ram, romByte & 0b00000111));
            case SUBB_IMM ->
            ...
            case CPL_ACC ->
                    OpcodeHelpers.readModifyWriteAccumulator(ram, (_, value) -> ~value);
            case CPL_BIT ->
